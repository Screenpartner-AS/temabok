...
$articles_from_subject = get_sub_field('articles_from_subject');
...
<div class="news-articles cf <?php echo $inverted_class; ?>">
  ...
  <div class="wrap cf">
    ...
    <div class="grid-skin">
          ...
          <div class="news-content-wrapper">
            ...
            <a href="<?php the_permalink($fa_id); ?>" title="<?php the_title_attribute(array('post'=>$fa_id)); ?>">
              ...
              <div class="news-content">
                ...
                <p class="news-desc"><?php echo get_field('education_article_settings', $fa_id)['short_description']; ?></p>
                <div class="article-categories">
                  <?php echo list_post_terms($fa_id, 'student_subject', 'cat', '#000'); ?>
                </div>
      ...
      if ($articles_from_subject) {
        $args['tax_query'] = array(
          array(
      			'taxonomy' => 'student_subject',
      			'field' => 'slug',
      			'terms' => $articles_from_subject,
      			'operator' => 'IN'
      		)
      	);
      }
            ...
            <div class="news-content-wrapper">
              ...
              <a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>">
                ...
                <div class="news-content">
                  ...
                  <div class="article-categories">
                    <?php echo list_post_terms($post->ID, 'student_subject', 'cat', '#000'); ?>
                  </div>
