...
<?php if( have_rows('log_in_builder_builder', 'option') ): ?>

  <div class="builder cf">

    <?php while ( have_rows('log_in_builder_builder', 'option') ) : the_row(); ?>
      ...
      <?php elseif( get_row_layout() == 'log_in_form' ): ?>


        <?php // logic is located in library/modules/elements/logo-section.php ?>
        <?php include(TEMPLATEPATH . '/library/modules/elements/log-in-form.php'); ?>
