							...
							<?php if (sp_is_logged_in_filter_active()) { ?>
								...
								<?php if (is_user_logged_in()) { ?>
									...
									<?php } else { ?>
										...
										<?php get_template_part('template-parts/content', 'publication-hidden'); ?>
								...
								<?php } else { ?>
									...
									<?php get_template_part('template-parts/content', 'publication-hidden'); ?>
									<p class="message error"><?php echo __('Please log in to read this theme book.', 'screenpartner'); ?></p>
									<?php load_template(TEMPLATEPATH . '/library/modules/layout-sections/simple-log-in-wrap.php'); ?>
