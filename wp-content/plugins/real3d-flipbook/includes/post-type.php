...
class R3D_Post_Type
{
  ...
  public function __construct()
  {
    ...
    $labels = array(
        ...
        'add_new_item'       => __( 'Add New Book', 'r3dfb' ),
        'new_item'           => __( 'New Book', 'r3dfb' ),
        'edit_item'          => __( 'Edit Book', 'r3dfb' ),
        'view_item'          => __( 'View Book', 'r3dfb' ),
        'all_items'          => __( 'All Books', 'r3dfb' ),
        'search_items'       => __( 'Search Book', 'r3dfb' ),
        'parent_item_colon'  => __( 'Parent Book:', 'r3dfb' ),
        'not_found'          => __( 'No Book found.', 'r3dfb' ),
        'not_found_in_trash' => __( 'No Book found in Trash.', 'r3dfb' )
    );
  ...
  // public function r3d_content( $content ){
  ...
  public function r3d_cat_columns_content( $c, $column_name, $term_id = "" )
  {
    ...
    return '<code>[real3dflipbook category="' . get_term( $term_id, 'r3d_category' )->slug . '"]</code>';
