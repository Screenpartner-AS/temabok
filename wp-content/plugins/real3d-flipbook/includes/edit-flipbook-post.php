<?php 
   ...
   // error_log(print_r( $current_id, true))
...
$flipbook = get_post_meta($post_id, 'flipbook_options', true);
if(!$flipbook){
   $flipbook = array();
}
...
wp_localize_script( 'real3d-flipbook-edit-post', 'flipbook', json_encode($flipbook) );