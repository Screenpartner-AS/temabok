...
* Tweak         - Adds "Nets D2 will be retired" notice.
* Fix           - Fixes deprecated WC_Order::get_order_currency.

= 2020.05.15	- version 2.8.0 =
* Feature       - Added ability to split card payments into two additional payment methods.
