...
//                'import' => __('Import as new item'),
        ...
        $out['conflict_with_existing_post'] = array(
            ...
            'help_text_conditional'=>array(
                array(
                    'help_text'=> __('If the post ID of the product being imported exists already(for any of the other post types like coupon, order, user, pages, media etc) skip the product from being inserted into the store.', 'wt-import-export-for-woo'),
                    'condition'=>array(
