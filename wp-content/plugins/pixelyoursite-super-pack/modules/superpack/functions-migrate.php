...
function migrate_v2_1_8_options() {
    ...
    if($categoryPixels && PixelYourSite\isWooCommerceActive()) {
    ...
    if($categoryPixels && PixelYourSite\isEddActive()) {
