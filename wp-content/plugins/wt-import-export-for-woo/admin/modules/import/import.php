        ...
        public function __construct()
	{
		...
		$this->steps=array(
			'post_type'=>array(
				...
				'description'=>__('Import the respective post type from a CSV/XML. As a first step you need to choose the post type to start the import.'),
			),
			'method_import'=>array(
...
//				return $str;
        ...
        public function get_decimal_columns(){
            return apply_filters('wt_iew_importer_decimal_columns', array('price','regular_price','_regular_price','sale_price','_sale_price','stock'));             
        }
        /*
         * 
         */
